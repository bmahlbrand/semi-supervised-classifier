...
class AutoEncoder(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.encoder = {
            'conv0': nn.Conv2d(3, 64, kernel_size=1),
            # (64)3c-4p-
